...
import {users, courses, lectures, discussions, attendance, messages} from "../config/mongoCollections.js";
...
const professors = [];
const professorData = [
    {firstName: "Patrick", lastName: "Hill", email: "phill@stevens.edu", gender: "male"},
    {firstName: "Zumrat", lastName: "Ackam", email: "zackam@stevens.edu", gender: "female"},
    {firstName: "Johnggi", lastName: "Hong", email: "jhong@stevens.edu", gender: "male"},
    {firstName: "Miranda", lastName: "Zhang", email: "mzhang@stevens.edu", gender: "female"}
];
...
for (const prof of professorData) {
    ...
    await usersCollection.updateOne({email: prof.email}, {$set: {accessStatus: "approved"}});
...
for (const student of studentData) {
    ...
    await usersCollection.updateOne({email: student.email}, {$set: {accessStatus: "approved"}});
...
const coursesList = [
    ...
    {name: "Database Management Systems", code: "CS-542", professor: professors[0]},
    {name: "Human Computer Interaction", code: "CS-545", professor: professors[1]},
    {name: "Intro to Computer Science", code: "CS-501", professor: professors[1]},
    {name: "Intro to Machine Learning", code: "CS-559", professor: professors[2]},
...
for (const course of coursesList) {
    ...
    const timeMap = {
        "CS-546": [{startTime: "10:00", endTime: "11:50"}, {startTime: "10:00", endTime: "11:50"}],
        "CS-542": [{startTime: "14:00", endTime: "15:50"}, {startTime: "14:00", endTime: "15:50"}],
        "CS-545": [{startTime: "12:00", endTime: "13:50"}, {startTime: "12:00", endTime: "13:50"}],
        "CS-501": [{startTime: "09:00", endTime: "10:50"}, {startTime: "09:00", endTime: "10:50"}],
        "CS-559": [{startTime: "15:00", endTime: "16:50"}, {startTime: "15:00", endTime: "16:50"}],
        "CS-570": [{startTime: "11:00", endTime: "12:50"}, {startTime: "11:00", endTime: "12:50"}],
        "CS-555": [{startTime: "16:00", endTime: "17:50"}, {startTime: "16:00", endTime: "17:50"}],
        "CS-554": [{startTime: "13:00", endTime: "14:50"}, {startTime: "13:00", endTime: "14:50"}]
    };
...
for (const course of coursesList) {
    ...
    switch (course.name) {
        case "Web Development":
            lectureTopics.push(
                ...
                {title: "JavaScript Basics", desc: "Introduction to programming with JavaScript", date: "2025-09-16"},
                {title: "Learning AJAX", desc: "Working with asynchronous JavaScript and XML", date: "2025-09-23"}
            );
            break;
        case "Database Management Systems":
            lectureTopics.push(
                ...
                {title: "SQL Fundamentals", desc: "Learning basic SQL queries and operations", date: "2025-09-10"},
                {title: "Normalization", desc: "Database normalization and design principles", date: "2025-09-17"},
                {title: "Transactions & Concurrency", desc: "Managing database transactions", date: "2025-09-24"}
            );
            break;
        case "Human Computer Interaction":
            lectureTopics.push(
                ...
                {title: "Usability Testing", desc: "Methods for evaluating interface usability", date: "2025-09-16"},
                {
        ...
        case "Intro to Computer Science":
            lectureTopics.push(
                ...
                {title: "Data Representation", desc: "How computers store and represent data", date: "2025-09-17"},
                {
        ...
        case "Intro to Machine Learning":
            lectureTopics.push(
                {title: "ML Fundamentals", desc: "Introduction to machine learning concepts", date: "2025-09-04"},
                {title: "Linear Regression", desc: "Understanding linear models for prediction", date: "2025-09-11"},
                {title: "Classification Algorithms", desc: "Techniques for categorizing data", date: "2025-09-18"},
                {
        ...
        case "Data Structures":
            lectureTopics.push(
                ...
                {title: "Trees & Graphs", desc: "Hierarchical and network data structures", date: "2025-09-17"},
                {title: "Hashing & Hash Tables", desc: "Efficient data retrieval techniques", date: "2025-09-24"}
            );
            break;
        case "Computer Networks":
            lectureTopics.push(
                ...
                {title: "Network Protocols", desc: "Understanding communication protocols", date: "2025-09-09"},
                {title: "Routing & Addressing", desc: "How data finds its way through networks", date: "2025-09-16"},
                {title: "Network Security", desc: "Protection against threats and vulnerabilities", date: "2025-09-23"}
            );
            break;
        case "Software Engineering":
            lectureTopics.push(
                ...
                {title: "Testing & QA", desc: "Ensuring software quality and reliability", date: "2025-09-25"}
            );
            break;
    }
    ...
    for (const topic of lectureTopics) {
        ...
        const lecture = await lectureData.createLecture(
            ...
            endTime,
            topic.desc,
            `https://scholorio.com/materials/${course.code}/${topic.title.toLowerCase().replace(/\s+/g, '-')}`
        );
...
for (const courseCode in lectureMap) {
    ...
    for (const lecture of lectureMap[courseCode]) {
        if (["Learning AJAX", "SQL Fundamentals", "Gradient Descent", "Introduction to HCI"].includes(lecture.title)) {
            const course = await coursesCollection.findOne({_id: new ObjectId(courseId)});
            ...
            switch (lecture.title) {
                case "Learning AJAX":
                    ...
                    discussionContent = "Let's discuss any challenges or questions you have about implementing AJAX in your projects.";
                    break;
                case "SQL Fundamentals":
                    discussionTitle = "SQL Query Help Thread";
                    discussionContent = "Post your SQL query problems here and we'll help troubleshoot them.";
                    break;
                case "Gradient Descent":
                    discussionTitle = "Understanding Gradient Descent Algorithm";
                    discussionContent = "What are the key challenges you're facing in understanding the gradient descent algorithm?";
                    break;
                case "Introduction to HCI":
                    discussionTitle = "Discussing User Interface Design Principles";
                    discussionContent = "How do you apply these principles in real applications?";
                    break;
            }
            ...
            const comments = [
                {
                    ...
                    comment: "Please share your questions about the topics covered in the lecture."
                },
                {
                    commenterId: studentCommenters[0],
                    comment: lecture.title === "Gradient Descent" ?
...
for (const courseCode in taAssignments) {
    ...
    const studentEnrollments = course.studentEnrollments
        .filter(enrollment => enrollment.status === "active")
        .filter(enrollment => {
            return !tas.some(ta => ta._id.toString() === enrollment.studentId.toString());
        });
    ...
    if (studentEnrollments.length >= 2) {
        ...
        for (const enrollment of messagingStudents) {
            ...
            await messagesCollection.insertOne({
                ...
                message: "I'm having trouble understanding the requirements for the upcoming assignment. Could you clarify what's expected for the third part?",
            ...
            await messagesCollection.insertOne({
                ...
                message: "I'd be happy to help clarify the assignment requirements. The third part is asking you to implement the algorithm we discussed in lecture using the data structure of your choice.",
