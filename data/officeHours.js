...
export const addTAOfficeHour = async ({courseId, userId, day, startTime, endTime, location, notes}) => {
...
export const deleteTAOfficeHour = async ({courseId, officeHourId, userId}) => {
